...
template <typename overshift, typename message_block_type>
struct shift_down
{
    void operator() (message_block_type&,
          std::uint64_t,
...
struct shift_down<bool_type<false>, message_block_type>
{
...
typename HashTraits::digest_type finalize(typename HashTraits::message_block_type& state,
    ...
    */
    ...
    shift_down<bool_type<overshift>, message_block_type>()(state, message_size, value_type_mask);
