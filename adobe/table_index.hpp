...
\par Terminology:
    ...
    - Transformation Function : given an element returns 1 or more columns. The result is by const
reference so columns must be adjacent
    - Key : a value which can be compared against a single member of an element

The table_index does <i>not</i> own the elements it indexes. Therefore the client is required to
maintain the elements in the table_index as long as the table_index refers to them.
...
/*!
\fn adobe::table_index::iterator adobe::table_index::insert(adobe::table_index::iterator position,
adobe::table_index::value_type& x)
...
/*!
\fn void adobe::table_index::insert(adobe::table_index::iterator position, InputIterator first,
InputIterator last)
...
\post
    The elements found in <code>(first, last]</code> must exist as long as this table's references
to them exist.
*/
...
/*!
\fn adobe::table_index::iterator adobe::table_index::erase(adobe::table_index::iterator first,
adobe::table_index::iterator last)
...
Sorts all the elements in the table based on their transformed values as compared with the
...
/*!
\fn adobe::table_index::const_iterator adobe::table_index::find(const adobe::table_index::key_type&
x) const
...
/*!
\fn adobe::table_index::size_type adobe::table_index::count(const adobe::table_index::key_type& x)
const
...
/*!
\fn adobe::table_index::iterator adobe::table_index::lower_bound(const adobe::table_index::key_type&
x)
...
\return
    The first position where the element transformed to \c x could be inserted without violating the
...
/*!
\fn adobe::table_index::iterator adobe::table_index::upper_bound(const adobe::table_index::key_type&
x)
...
\return
    The last position where the element transformed to \c x could be inserted without violating the
ordering of the table.
*/
