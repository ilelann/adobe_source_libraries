...
struct eve_callback_suite_t {
    ...
    typedef function<position_t(const position_t& parent,
    ...
    typedef function<void(cell_type_t type, name_t name, const line_position_t& position,
                                 const array_t& initializer, const std::string& brief,
                                 const std::string& detailed)> add_cell_proc_t;

    typedef function<void(const line_position_t& position, const array_t& conditional,
    ...
    typedef function<void()> finalize_sheet_proc_t;
